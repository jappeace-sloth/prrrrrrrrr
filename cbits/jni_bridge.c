/*
 * JNI bridge for prrrrrrrrr (me.jappie.prrrrrrrrr).
 *
 * This replaces haskell-mobile's default jni_bridge.c which uses
 * the me.jappie.haskellmobile package name.  Built via extraNdkCompile
 * and overwrites jni_bridge.o so the linker picks up the correct
 * JNI symbol names for this app's Java package.
 */
...
/* --- prrrrrrrrr-specific: setFilesDir --- */

JNIEXPORT void JNICALL
Java_me_jappie_prrrrrrrrr_MainActivity_setFilesDir(JNIEnv *env, jobject thiz, jstring path)
{
...
/* --- Standard haskell-mobile JNI methods --- */

JNIEXPORT jstring JNICALL
Java_me_jappie_prrrrrrrrr_MainActivity_greet(JNIEnv *env, jobject thiz, jstring jname)
{
...
JNIEXPORT void JNICALL
Java_me_jappie_prrrrrrrrr_MainActivity_renderUI(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT void JNICALL
Java_me_jappie_prrrrrrrrr_MainActivity_onButtonClick(JNIEnv *env, jobject thiz, jobject view)
{
    android_handle_click(env, view);
}

JNIEXPORT void JNICALL
Java_me_jappie_prrrrrrrrr_MainActivity_onTextChange(JNIEnv *env, jobject thiz, jobject view, jstring text)
{
...
JNIEXPORT void JNICALL
Java_me_jappie_prrrrrrrrr_MainActivity_onLifecycleCreate(JNIEnv *env, jobject thiz)
{
    haskellOnLifecycle(g_haskell_ctx, LIFECYCLE_CREATE);
}

JNIEXPORT void JNICALL
Java_me_jappie_prrrrrrrrr_MainActivity_onLifecycleStart(JNIEnv *env, jobject thiz)
{
    haskellOnLifecycle(g_haskell_ctx, LIFECYCLE_START);
}

JNIEXPORT void JNICALL
Java_me_jappie_prrrrrrrrr_MainActivity_onLifecycleResume(JNIEnv *env, jobject thiz)
{
    haskellOnLifecycle(g_haskell_ctx, LIFECYCLE_RESUME);
}

JNIEXPORT void JNICALL
Java_me_jappie_prrrrrrrrr_MainActivity_onLifecyclePause(JNIEnv *env, jobject thiz)
{
    haskellOnLifecycle(g_haskell_ctx, LIFECYCLE_PAUSE);
}

JNIEXPORT void JNICALL
Java_me_jappie_prrrrrrrrr_MainActivity_onLifecycleStop(JNIEnv *env, jobject thiz)
{
    haskellOnLifecycle(g_haskell_ctx, LIFECYCLE_STOP);
}

JNIEXPORT void JNICALL
Java_me_jappie_prrrrrrrrr_MainActivity_onLifecycleDestroy(JNIEnv *env, jobject thiz)
{
    haskellOnLifecycle(g_haskell_ctx, LIFECYCLE_DESTROY);
}

JNIEXPORT void JNICALL
Java_me_jappie_prrrrrrrrr_MainActivity_onLifecycleLowMemory(JNIEnv *env, jobject thiz)
{
